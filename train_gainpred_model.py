...
if __name__ == "__main__":
    ...
    model, train_loss_list, train_mae_list, train_mse_list, \
        ...
        val_bestBS_mae_list, val_bestBS_mse_list = \
            train_gainpred_model(num_epochs, device, data_torch, veh_h_torch, best_beam_pair_index_torch, M_t, M_r, pretrained_model_path, model_save_dir,pos_in_data=(preprocess_mode==2))
